...
git switch main
git add docs/VERSION_CONTROL_WORKFLOE.md
git commit -m “docs: add version control workflow documentation”
git merge conflict-demo-a
git push origin main
git log --oneline --graph --all
-------------------------------------------------------------------------------------------------------------------------------
Verification & Execution Steps
•	git --version returns a version ≥ 2.30.
•	git log --oneline --graph --all shows a graph with main, develop, and merged branches, e.g.:
*   a1b2c3d (HEAD -> main) merge: combine n_estimators and max_depth tuning changes
|\
| * e4f5g6h feat: add max_depth=10 to RandomForest
* | h7i8j9k feat: change n_estimators to 150
|/
* 1a2b3c4 chore: initialize project structure with baseline training script
